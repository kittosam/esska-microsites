...
MP="Oliver Marin-Pena"; AP="Athanasios Papavasiliou"
...
DAY1=("1","2027-04-15","Thu","Thursday 15 April 2027","10:00","18:00",[
 ...
 ("10:17","11:17","Session I &middot; FAI in the High-Impact Athlete",[("Moderators",f"{MP} and Tashim Beyzadeoglu")],
  [("FAI in pivoting sports: which morphology really matters?","Filippo Randelli"),("Labrum: repair, augmentation or reconstruction?","Baris Kocaoglu"),
   ("Capsule: when is closure not enough?","Safa Gursoy"),("Cartilage damage in the athlete: when does arthroscopy stop making sense?","Ali Bajwa")],
  "About 32 minutes of interactive case discussion, with stepwise cases, audience voting and re-voting after discussion. Panel: Filippo Randelli, Baris Kocaoglu, Safa Gursoy, Ali Bajwa and Nicolas Bonin.",False),
 ...
 ("13:17","14:17","Session III &middot; The Athlete with DDH and Structural Borderlines",[("Moderators",f"{AP} and Panos Christofilopoulos")],
  [("Borderline dysplasia: instability or impingement?","Michael Wettstein"),("Imaging structural instability beyond the LCEA","Musculoskeletal radiologist, to be confirmed"),
  ...
  "About 32 minutes of interactive structural-decision cases, with votes on arthroscopy, PAO, osteotomy, combined treatment or no surgery. Panel: Michael Wettstein, a musculoskeletal radiologist, Sufian S. Ahmad, Ajay Malviya and Panos Christofilopoulos.",False),
 ("14:17","14:47","Afternoon coffee and industry exhibition",[],[],None,True),
 ("14:47","15:47","Session IV &middot; Rehabilitation and Return to Sport",[("Moderators","Dora Papadopoulou and Tashim Beyzadeoglu")],
 ...
 ("15:47","16:42","Session V &middot; Innovation: Evidence or Enthusiasm?",[("Moderators","Jakub Kautzner and Elefterios Tsiridis")],
 ...
 ("16:42","17:42","Final Interactive Challenge: The Athletic Hip Case That Divides the Faculty",[("Case presenters",f"{MP} and {AP}")],[],
  "Two complex cases of about 30 minutes each: vote, panel debate, audience questions, re-vote, then the actual treatment and outcome. Panel: Vikas Khanduja, Ajay Malviya, Baris Kocaoglu, Michael Wettstein, Filippo Randelli, Panos Christofilopoulos and Elefterios Tsiridis.",False),
...
DAY2=("2","2027-04-16","Fri","Friday 16 April 2027","08:00","11:30",[
 ...
 ("08:50","09:50","Session VII &middot; Training the Hip Preservation Surgeon of the Future",[("Moderators","Daniel Perez-Prieto and Safa Gursoy")],
  [("How should hip arthroscopy be taught?","Jacek Mazek"),("Cadaveric training: what skills should be assessed?",AP),
   ("ESSKA Hip Core Curriculum &rarr; Academy &rarr; Courses","Daniel Perez-Prieto"),("From course attendance to competency-based certification",MP)],
  f"About 32 minutes of faculty discussion, with votes on competencies and assessment standards. Panel: Jacek Mazek, {AP}, Daniel Perez-Prieto, {MP}, Vikas Khanduja and Andre Sarmento.",False),
 ...
 ("10:10","11:10","Session VIII &middot; Failed Hip Preservation: Revision, Salvage and Treatment Boundaries",[("Moderators","Filippo Randelli and Michael Wettstein")],
  ...
  "About 32 minutes of difficult-case discussion, with votes on revision arthroscopy, PAO, osteotomy, combined reconstruction or THA. Panel: Nicolas Bonin, Jacek Mazek, Panos Christofilopoulos, Daniel Haverkamp, Ajay Malviya and Elefterios Tsiridis.",False),
 ("11:10","11:30","Academy Integration, Next Steps and Closing",[("Moderators",f"{MP} and {AP}")],
  [("Academy-ready content and educational gaps","Daniel Perez-Prieto"),("Strategic next steps and certification pathway",MP)],None,False),
])
...
FACULTY=[("Sufian S. Ahmad","Germany"),("Ali Bajwa","United Kingdom"),("Nicolas Bonin","France"),("Bruno Capurro","Spain"),
 ("Francesco Della Villa","Italy"),("Safa Gursoy","T&uuml;rkiye"),("Daniel Haverkamp","Netherlands"),("Per Holmich","Denmark"),
 ...
 ("Marc Tey Pons","Spain"),("Michael Wettstein","Switzerland"),("Robert Prill","Germany"),("Stefano Di Paolo","Italy"),("Daniel Perez-Prieto","Spain"),
 ("Laura de Girolamo","Italy"),("Panos Christofilopoulos","Switzerland"),("Dora Papadopoulou","United Kingdom and Greece"),
 ("Tashim Beyzadeoglu","T&uuml;rkiye"),("Jakub Kautzner","Czech Republic"),("Elefterios Tsiridis","Greece")]
